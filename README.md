...
Here,
-n represents the number of data points in our dataset,k represents the number of independent variables, and R represents the R-squared values determined by the model.
